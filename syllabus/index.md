...
[Download a PDF version]({{ site.baseurl }}/assets/files/AVT415-Syllabus-Spring2026.pdf)
...
### Course Description
Building on existing skills and principles, this course delves deeper into web-related concepts and techniques. Students will gain knowledge about usability and build their design skills as they relate to the web. IMPORTANT: a foundational level of design knowledge is assumed to allow us more time to focus on the projects themselves.

### Objectives
* Develop general design skills
* Apply best practices for accessibility and usability as they relate to the designing of websites
...
#### browser
<span class="command">Chrome</span>, Safari, or Firefox (viewing the web). Internet Explorer and Microsoft Edge are not acceptable browsers for this class
...
#### project 1: tell a story
 Design and prototype a single page, responsive website that tells the history, process, or story of a selected topic. The page can be on any topic and will be built out to include six total sections to help explain the topic. [More information here]({{ site.baseurl }}/projects).
